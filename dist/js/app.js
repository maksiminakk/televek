window.addEventListener("DOMContentLoaded", function () {
    ...
    const menuBody = document.querySelector('.header-bottom__nav');
    const iconMenu = document.querySelector('.header-top__burger-icon');
    if (iconMenu) {
    ...
    document.addEventListener('wpcf7mailsent', function (event) {
        ...
        if ('92' == event.detail.contactFormId) {
            popupOpen(document.getElementById('confirm-3'));
        } else if ('91' == event.detail.contactFormId) {
            popupOpen(document.getElementById('confirm-2'));
        } else {
            popupOpen(document.getElementById('confirm'));
        }
    }, false);
    ...
    function toggleActiveClass(el) {
        ...
        el.parentElement.classList.toggle('_checked');
    }
